...
const loadProfile = data => {
  ...
  for (i = 0; i < post.length; i++) {
    ...
    const containerProfileImg = document.createElement("div");
...
function cambiar(ev) {
  if(ev.style.fill === 'red') {
    ev.style.fill = "#262626";
